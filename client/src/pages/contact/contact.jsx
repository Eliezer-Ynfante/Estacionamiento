            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full textarea-contact resize-none"
              ...
              {/* Mensaje de Éxito */}
              {submitted && (
                <div className="animate-in fade-in slide-in-from-top-2 duration-300 bg-orange-600/10 border-l-4 border-orange-600 p-4 rounded">
